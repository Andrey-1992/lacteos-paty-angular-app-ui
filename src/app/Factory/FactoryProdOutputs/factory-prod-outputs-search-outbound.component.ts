...
@Component({
  selector: 'app-search-cheese-output-outbound',
  templateUrl: './factory-prod-outputs-search-outbound.component.html',
  styleUrls: ['./factory-prod-outputs-search-outbound.component.css']
})

export class FactoryProdOutputsSearchOutbound {
  ...
  searchRecords() {
    ...
    this.filterDataByDate = this.dataHandlingService.filterDataByDateOutbound(this.selectedCategory, this.selectedMonth, this.selectedYear);
  }
